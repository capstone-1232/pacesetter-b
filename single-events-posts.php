	...
	<main id="primary" class="site-main">
        <a href="#"><< Back to Events</a>
            <article>
                ...
                <aside>
                    ...
                    <h3>Reserve your spot at this event!</h3>
                    <!-- RSVP capacity -->
                    <p>Spots left: <?php echo $capacity?></p>
                    <!-- RSVP Form -->
                    <form id="myForm" action="" method="POST">
                        ...
                        <div>
                            ...
                            <p><?php echo $full_name_message?></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p><?php echo $phone_number_message?></p>
                        </div>
        ...
        <div id="eventModal" class="event-modal <?php echo (!in_array($event_id, $_SESSION['form_submission_identifier'])) ? "hidden" : "" ?>">
            <div class="event-modal-content">
                ...
                <span class="event-modal-close"><svg width="42px" height="42px" viewBox="0 -0.5 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>close [#1511]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-419.000000, -240.000000)" fill="#000000"> <g id="icons" transform="translate(56.000000, 160.000000)"> <polygon id="close-[#1511]" points="375.0183 90 384 98.554 382.48065 100 373.5 91.446 364.5183 100 363 98.554 371.98065 90 363 81.446 364.5183 80 373.5 88.554 382.48065 80 384 81.446"> </polygon> </g> </g> </g> </g></svg></span>
