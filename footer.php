...
<?php
// Replace 'pacesetter-edmonton' with the actual slug of your page
		...
		<div class="store-info">
			<div>
				<div>
					<div>
						<h3>Hours</h3>
						<p>Mon-Fri: <?php echo $hours_mon_fri;?></p>
						<p>Sat: <?php echo $hours_sat;?></p>
						<p>Sun: <?php echo $hours_sun;?></p>
					</div>
					<div>
						<h3>Location</h3>
						<p><?php echo $address;?>, </p>
						<p><?php echo $city . ', ' . $province . ' ' . $postal_code;?></p>
					</div>
				</div>
				<div>
					<div>
					...
					<nav id="site-navigation" class="main-navigation">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'pacesetter' ); ?></button>
						<?php
						wp_nav_menu(
							array(
